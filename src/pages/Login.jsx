        ...
        <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
          <div className="max-w-xl lg:max-w-3xl">
            <div className="relative -mt-16 block lg:hidden">
              ...
              <h1 className="mt-2 text-2xl font-bold text-gray-900 dark:text-white sm:text-3xl md:text-4xl">Login to your account</h1>

              <p className="mt-4 leading-relaxed text-gray-500 dark:text-gray-400">You need to login for more further information</p>
            </div>
            ...
            <form onSubmit={handleLogin} className="mt-8 grid grid-cols-6 gap-6">
              ...
              <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                ...
                <p className="mt-4 text-sm text-gray-500 dark:text-gray-400 sm:mt-0">
                  ...
                  <Link to={"/register"} className="text-gray-700 underline dark:text-gray-200">
                    Register
                  </Link>
                  .
                </p>
