      ...
      <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
        <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
          ...
          <div className="hidden lg:relative lg:block lg:p-12">
            <h2 className="mt-6 text-2xl font-bold text-white sm:text-3xl md:text-6xl">
              Login to your account
            </h2>

            <p className="mt-4 leading-relaxed text-white/90 text-2xl">
              You need to login for more further information, such as{" "}
              <Typed
                strings={[
                  "Upcoming Movies.",
                  "Popular Movies.",
          ...
          <div className="max-w-xl lg:max-w-3xl">
            <div className="relative -mt-16 block lg:hidden">
              ...
              <p className="mt-4 leading-relaxed text-gray-500 dark:text-gray-400">
                You need to login for more further information
              </p>
            </div>
